...
historical data on spot and future prices. The data set in package \pkg{empfin} was
obtained from that source.

## Libor Rates

The package \pkg{empfin} also contains a data set of USD libor and swap rates
