...
```{r, BasicIR,echo=FALSE,results='hide'}
  library(timeDate)
  library(empfin)
```
...
```{r, label=CleanDirty, results='hide', warning=FALSE, message=FALSE}
  # define a bond
  b375 <- Bond('375', dmy('01jan2000'), dmy('04jan2019'), 0.0375, 100, 'a')
  b300 <- Bond('300', dmy('01jan2000'), dmy('04jan2019'), 0.0300, 100, 'a')
  dtToday <- dmy('25mar2010')
  dt <- timeSequence(dtToday, dmy('04jan2019'), by='day')
