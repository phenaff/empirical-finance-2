...
```{r, label=bond-1, echo=TRUE}
  b1 <- Bond(id='b1', dtIssue=dmy('01jan2000'), dtMaturity=dmy('15dec2018'),
             couponRate=.05, nominal=100, frequency='a')

  # price on coupon date
  dtSettlement <- dmy('17dec2010')
...
```{r, Bund374}
  ai = 3.00 * as.numeric(dmy('10jun2010')-dmy('04Jan2010'))/365
  ai
```
