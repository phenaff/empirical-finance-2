...
```{r 102-sce-plot, fig.cap="Call Price as a function of spot value. Strike: 100, maturity: 1 Year", fig.scap="Call Price as a function of spot value", out.extra='', fig.margin=TRUE, fig.height=3}
